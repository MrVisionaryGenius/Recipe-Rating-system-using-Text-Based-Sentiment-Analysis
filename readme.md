...
## About
__This Project generates rating of a product in an e-commerce website by analyzing the text based review provided by the users using deep learning well I used this project for Rating Recipes.__ <br><br>
